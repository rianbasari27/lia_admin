        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center my-4 space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                    <svg aria-hidden="true" class="w-6 h-6 text-slate-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                    <a href="{{ url('/pembelian/'.$data->kode_pembelian.'/edit') }}" class="ml-1 text-sm font-medium text-slate-700 hover:text-red-700 md:ml-2 dark:text-slate-400 dark:hover:text-white">{{ $subtitle }}</a>
                    </div>
                </li>
            </ol>
        </nav>
                    ...
                    <div class='border border-slate-400 p-7 rounded-lg mb-5'>
                        <div class="grid grid-cols-12 gap-1 mb-3">
                            ...
                            <div class="col-span-5">
                                ...
                                <input type='text' name='kode_pembelian' id='kode_pembelian' readonly value="{{ $data->kode_pembelian }}" class="@error('kode_pembelian') border-red-400 @enderror w-[250px] p-1 bg-slate-300 rounded-md border focus:border-red-400 focus:ring-red-400">
                    ...
                    <div class='flex border border-slate-400 p-7 rounded-lg mb-5'>
                        <div class='w-full'>
                                ...
                                @foreach ($detail as $item)
                                    <div class="grid grid-cols-12 gap-3 mb-2 duplicate-row">
                                        ...
                                        <div class="col-span-3">
                                            <input type='text' name='nama_barang[]' id='nama_barang' value="{{ $item->nama_barang }}" class="w-full p-1 rounded-md border @error('nama_barang.*') border-red-400 @enderror focus:border-red-400 focus:ring-red-400">
                                            @error('nama_barang.*')
                                                <div class="text-red-700 text-start">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-span-2">
                                            <div class="flex">
                                                ...
                                                <div>
                                                    <input type='number' name='jumlah[]' id='jumlah' value="{{ $item->jumlah }}" class="w-full p-1 rounded-md border @error('jumlah.*') border-red-400 @enderror focus:border-red-400 focus:ring-red-400">
                                                </div>
                                            </div>
                                            @error('jumlah.*')
                                            <div class="text-red-700 text-start">
                                        ...
                                        <div class="col-span-3">
                                            <span class='mr-2'>Rp</span><input type='number' name='biaya[]' id='biaya' value="{{ $item->biaya }}" class='biaya w-52 p-1 rounded-md border @error('biaya.*') border-red-400 @enderror focus:border-red-400 focus:ring-red-400'>
                                            @error('biaya.*')
                                                <div class="text-red-700 text-start">
                                                    {{ $message }}
                                                </div>
                            ...
                            <div class="grid grid-cols-12 gap-4 mt-5 mb-2">
                                ...
                                <div class="col-span-3">
                                    <span class='mr-2'>Rp</span><input type='number' name='total' id='total' value="{{ $data->total }}" class='w-52 p-1 rounded-md border border-slate-400 bg-slate-200 focus:ring-0 focus:border-slate-400' readonly>
                                </div>
                            </div>
