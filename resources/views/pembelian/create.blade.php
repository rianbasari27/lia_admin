        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center my-4 space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                    <svg aria-hidden="true" class="w-6 h-6 text-slate-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                    <a href="/pembelian/create" class="ml-1 text-sm font-medium text-slate-700 hover:text-red-700 md:ml-2">{{ $subtitle }}</a>
                    </div>
                </li>
            </ol>
        </nav>
                        ...
                        <div class="grid grid-cols-12 gap-1 mb-3">
                            ...
                            <div class="lg:col-span-5 col-span-12 lg:mb-0 mb-2">
                                <div>
                                    ...
                                    <input type='text' name='kode_pembelian' id='kode_pembelian' value="{{ $kode_pembelian }}" class="@error('kode_pembelian') border-red-400 @enderror lg:w-[250px] w-full p-1 rounded-md border focus:border-red-400 focus:ring-red-400">
                                </div>
                            ...
                            <div class="lg:col-span-5 col-span-12 lg:mb-0 mb-3">
                                <div>
                                ...
                                @error('tanggal')
                                    <div class="text-red-700 text-start lg:ml-[155px]">
                                        {{ $message }}
                                    </div>
                                @enderror
                            </div>
                            
                            <div class="lg:col-span-5 col-span-12 flex">
                                <div>
                                    <div>
                                ...
                                <div>    
                                    <a href="{{ url('/supplier') }}" id='add_supp' class='block shadow-md lg:mt-0 mt-5 bg-slate-200 border border-slate-400 font-semibold px-1.5 py-2 ml-2 rounded-md hover:bg-red-700 hover:text-white hover:border-red-700 text-slate-600 duration-150'>
                    ...
                    <div class='flex border border-slate-400 lg:p-7 p-4 rounded-lg mb-5'>
                        <div class='w-full'>
                            ...
                            <div class="mb-3 lg:text-sm text-xs">
                                <button type="button" id='add' class='flex shadow-md add-row bg-slate-200 font-semibold p-2 rounded-md hover:bg-red-700 hover:text-white text-slate-600 duration-150'>
                            ...
                            <div class="multiple-records">
                                <div class="grid grid-cols-12 gap-3 mb-2 duplicate-row lg:border-0 border border-slate-400 lg:bg-white bg-slate-50 lg:shadow-none shadow-lg lg:p-0 p-4 rounded-md">
                                    <div>
                                        <button type='button' id='remove' class='remove-row px-3 py-2 rounded shadow-md text-slate-600 bg-slate-200 hover:bg-red-700 hover:text-white duration-150'>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
