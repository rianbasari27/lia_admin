...
@section('main-content')
    <div>
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center my-4 space-x-1 md:space-x-3">
                ...
                <li>
                    ...
                    <a href="/customer" class="ml-1 text-sm font-medium text-slate-700 hover:text-red-700 md:ml-2">{{ $title }}</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
                    <svg aria-hidden="true" class="w-6 h-6 text-slate-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                    <a href="{{ url('/customer/'.$data->id.'/edit') }}" class="ml-1 text-sm font-medium text-slate-700 hover:text-red-700 md:ml-2">{{ $subtitle }}</a>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class='flex justify-between'>
            ...
            <a href='/customer' class='flex px-3 py-2 bg-slate-500 rounded-lg shadow-md text-white hover:bg-slate-600 focus:ring focus:ring-slate-300'>
            ...
            <div class="font-light">
                <form action="{{ '/customer/'.$data->id }}" method="post">
                    ...
                    <div class="lg:flex mb-3">
                        ...
                        <div>
                            <input type="text" name="nama_customer" id="nama_customer" value="{{ $data->nama_customer }}" class="lg:w-[400px] w-full p-1 rounded-md border border-slate-400 focus:border-red-400 focus:ring-red-400">
                            @error('nama_customer')
                    ...
                    <div class="lg:flex mb-3">
                        ...
                        <div>
                            <div class="flex">
                                ...
                                <div>
                                    <input type="text" name="no_telepon" id="no_telepon" value="{{ $no_telp[1] }}" class="lg:w-[359px] p-1 rounded-r-md border border-slate-400 focus:border-red-400 focus:ring-red-400">
                                </div>
                            </div>
                            @error('no_telepon')
                            <div class="text-red-700 text-start">
                    ...
                    <div class="lg:flex mb-3">
                        ...
                        <div>
                            <textarea name="alamat" id="alamat" cols="50" class="block w-full p-1 rounded-md border border-slate-400 focus:border-red-400 focus:ring-red-400">{{ $data->alamat }}</textarea>
                            @error('alamat')
                                <div class="text-red-700 text-start">
                                    {{ $message }}
                                </div>
                ...
                <div>
                    ...
                    <a href="/customer" name="back" class="px-3 py-2 rounded-lg bg-slate-500 text-white hover:bg-slate-700 focus:ring focus:ring-slate-300"></i>Kembali</a>
                </div>
            </form>
        </div>
    </div>
