...
@section('main-content')
    <div>
        ...
        <div class='flex justify-between'>
            ...
            <a href='/customer' class='px-3 py-2 bg-slate-500 rounded-lg shadow-md text-white hover:bg-slate-600 focus:ring focus:ring-slate-300'>
            ...
            <div class="font-light">
                <form action="{{ '/customer/'.$data->id }}" method="post">
                    ...
                    <div class="flex mb-3">
                        ...
                        <div>
                            <input type="text" name="nama_customer" id="nama_customer" value="{{ $data->nama_customer }}" class="w-[400px] p-1 rounded-md border border-slate-400 focus:border-red-400 focus:ring-red-400">
                            @error('nama_customer')
