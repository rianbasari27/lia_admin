    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center lg:my-4 my-2 space-x-1 md:space-x-3">
            <li class="inline-flex items-center">
                <a href="/homes" class="inline-flex items-center text-sm font-medium text-slate-700 hover:text-red-700">
...
<form action="/customer" method="get" class="mt-5">
    <div class="lg:flex justify-between">
        ...
        <div class="lg:my-auto mt-5">
            <a href="/customer/create" class="flex w-fit px-3 py-2.5 bg-red-700 rounded-lg shadow-md text-white hover:bg-red-800 focus:ring focus:ring-red-200">
