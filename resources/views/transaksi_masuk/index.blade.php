...
<div>
    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center lg:my-4 my-2 space-x-1 md:space-x-3">
            ...
            <li>
                ...
                <span class="ml-1 text-sm font-medium text-slate-700 hover:text-red-700 md:ml-2">{{ $title }}</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="flex justify-between lg:mb-4 mb-2">
        ...
        <a href="/transaksi_masuk/create" class="flex lg:px-3 lg:py-2 px-2 py-1.5 bg-red-700 rounded-lg shadow-md text-white hover:bg-red-800 focus:ring focus:ring-red-200">
                    ...
                    <form action="/transaksi_masuk" method="get">
                        <div class="grid grid-cols-12 gap-1 mb-3">
                            ...
                            <div class="lg:col-span-3 col-span-12">
                                <input type="text" name="kode_transaksi" id="kode_transaksi" class="w-full p-1 rounded-md border border-slate-400 focus:border-red-400 focus:ring-red-400" value="{{ Request::input('kode_transaksi') }}">
                            </div>
                            <div></div>
                        ...
                        <div class="grid grid-cols-12 gap-1 mb-3">
                            ...
                            <div class="lg:col-span-3 col-span-12">
                                <div class="w-full">
                                    <input type="radio" name="tujuan_pembayaran" id="uang_muka" value="Uang muka" {{ (Request::input('tujuan_pembayaran') == 'Uang muka') ? 'checked' : '' }} class="rounded-full border border-slate-400 text-red-700 focus:ring-red-700">
                                    <label for="uang_muka" class="mr-3">Uang muka</label>
        
                                    <input type="radio" name="tujuan_pembayaran" id="pelunasan" value="Pelunasan" {{ (Request::input('tujuan_pembayaran') == 'Pelunasan') ? 'checked' : '' }} class="rounded-full border border-slate-400 text-red-700 focus:ring-red-700">
                        ...
                        <div class="flex">
                            <button type="submit" name="search" class="flex lg:px-3 lg:py-2 px-2 py-1.5 mr-1 rounded-lg bg-red-700 text-white hover:bg-red-800 focus:ring focus:ring-red-200">
                        ...
                        <tr class="border-b border-x border-slate-300 hover:bg-slate-100 text-slate-500">
                            ...
                            <td class="p-3">
                                <div class="flex justify-end">
                                    <div class="mr-2">
                                        <a href="{{ url('/transaksi_masuk/'.$item->kode_transaksi.'/edit') }}" class="block text-xs p-1.5 rounded-lg border border-slate-500 text-slate-500 hover:text-white hover:bg-emerald-500 hover:border-emerald-500">
                                            <span>
                                    ...
                                    <div class="mr-2">
                                        <a href="{{ url('/transaksi_masuk/'.$item->kode_transaksi) }}" class="block text-xs p-1.5 rounded-lg border border-slate-500 text-slate-500 hover:text-white hover:bg-amber-500 hover:border-amber-500">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
                                    ...
                                    <div class="mr-2">
                                        <form action="{{ '/transaksi_masuk/'.$item->kode_transaksi }}" method="post" onsubmit="return confirm('Ini akan menghapus detail transaksi masuk. Apakah Anda yakin ingin menghapus?')">
                                            @csrf
                                            @method('DELETE')
