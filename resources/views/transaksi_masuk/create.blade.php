                        ...
                        <div class="w-full">
                            ...
                            <div class='flex'>
                                ...
                                <div class="flex mb-3">
                                    ...
                                    <div>
                                        <span class="mr-2">Rp</span><input type='number' name='nominal' id='nominal' value="{{ old('nominal') }}" class="w-[250px] p-1 rounded-md border @error('nominal') border-red-400 @enderror focus:border-red-400 focus:ring-red-400">
                                        @error('nominal')
                                        <div class="text-red-700 text-start">
                                            {{ $message }}
                                        </div>
