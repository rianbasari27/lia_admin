    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-slate-200 sm:translate-x-0 dark:bg-slate-800 dark:border-slate-700" aria-label="Sidebar">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-slate-800">
            <ul class="space-y-2 font-medium mx-2">
                ...
                <li>
                    <button type="button" class="flex {{ $title == 'Laporan Kas Masuk' || $title == 'Laporan Kas Keluar' ? 'bg-red-700 text-white font-semibold' : 'hover:bg-slate-100' }} items-center w-full p-2 text-slate-500 transition duration-75 rounded-lg group" aria-controls="dropdown-laporan" data-collapse-toggle="dropdown-laporan">
                    ...
                    <ul id="dropdown-laporan" class="{{ $title == 'Laporan Kas Masuk' || $title == 'Laporan Kas Keluar' ? '' : 'hidden' }} py-2 space-y-2">
                        <li>
                            <a href="/laporan_kas_masuk" class="flex {{ $title == 'Laporan Kas Masuk' ? 'bg-red-300 text-white font-semibold' : 'hover:bg-slate-100' }} items-center w-full p-2 text-slate-500 transition duration-75 rounded-lg pl-11 group">Laporan pemasukan</a>
                        </li>
                        <li>
                            <a href="/laporan_kas_keluar" class="flex {{ $title == 'Laporan Kas Keluar' ? 'bg-red-300 text-white font-semibold' : 'hover:bg-slate-100' }} items-center w-full p-2 text-slate-500 transition duration-75 rounded-lg pl-11 group">Laporan pengeluaran</a>
                        </li>
                    </ul>
                </li>
                <li>
