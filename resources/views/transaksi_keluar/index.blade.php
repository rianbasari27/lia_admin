...
<div>
    ...
    <div class="flex justify-between">
        ...
        <a href="/transaksi_keluar/create" class="flex lg:px-3 lg:py-2 px-2 py-2 lg:text-sm bg-red-700 rounded-lg shadow-md text-white hover:bg-red-800 focus:ring focus:ring-red-200">
        ...
        <div id="accordion-collapse-body-3" class="hidden" aria-labelledby="accordion-collapse-heading-3">
            <div class="p-5 border border-t-0 border-slate-200">
                <div class="font-light">
                    ...
                    <form action="/transaksi_keluar" method="get">
                        <div class="grid grid-cols-12 gap-1 mb-3">
                            ...
                            <div class="lg:col-span-3 col-span-12">
                                <input type="text" name="kode_transaksi" id="kode_transaksi" value="{{ Request::input('kode_transaksi') }}" class="w-full p-1 rounded-md border border-slate-400 focus:border-red-400 focus:ring-red-400">
                            </div>
                            <div></div>
                        ...
                        <div class="grid grid-cols-12 gap-1 mb-3">
                            ...
                            <div class="lg:col-span-3 col-span-12">
                                <input type="text" name="transaksi_tujuan" id="transaksi_tujuan" value="{{ Request::input('transaksi_tujuan') }}" class="w-full p-1 rounded-md border border-slate-400 focus:border-red-400 focus:ring-red-400">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-12 gap-1 mb-3">
                            ...
                            <div class="lg:col-span-3 col-span-12">
                                <input type="text" name="pembayaran_lain" id="pembayaran_lain" value="{{ Request::input('pembayaran_lain') }}" class="w-full p-1 rounded-md border border-slate-400 focus:border-red-400 focus:ring-red-400">
                            </div>
                        </div>

                        <div class="flex">
                            <button type="submit" name="search" class="flex lg:px-3 lg:py-2 px-2 py-2 mr-1 lg:text-sm text-xs rounded-lg bg-red-700 text-white hover:bg-red-800 focus:ring focus:ring-red-200">
    ...
    <div class="bg-white mt-7 rounded-lg shadow-md">
        <div class="bg-slate-200 px-5 py-3 rounded-t-md">
            <span class="font-semibold text-slate-600">Transaksi keluar terbaru</span>
        </div>
        <div class="p-5">
            <div class="overflow-x-auto lg:border-0 border-x">
                <table class="lg:w-full w-[900px] rounded-lg lg:text-sm text-xs">
                        ...
                        <tr class="border-b border-x border-slate-300 hover:bg-slate-100 text-slate-500">
                            ...
                            <td class="p-3">
                                <div class="flex justify-end">
                                    <div class="mr-2">
                                        <a href="{{ url('/transaksi_keluar/'.$item->kode_transaksi.'/edit') }}" class="block text-xs p-1.5 rounded-lg border border-slate-500 text-slate-500 hover:text-white hover:bg-emerald-500 hover:border-emerald-500">
                                            <span>
                                    ...
                                    <div class="mr-2">
                                        <a href="{{ url('/transaksi_keluar/'.$item->kode_transaksi) }}" class="block text-xs p-1.5 rounded-lg border border-slate-500 text-slate-500 hover:text-white hover:bg-amber-500 hover:border-amber-500">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
                                    ...
                                    <div class="mr-2">
                                        <form action="{{ '/transaksi_keluar/'.$item->kode_transaksi }}" method="post" onsubmit="return confirm('Ini akan menghapus detail transaksi masuk. Apakah Anda yakin ingin menghapus?')">
                                            @csrf
                                            @method('DELETE')
