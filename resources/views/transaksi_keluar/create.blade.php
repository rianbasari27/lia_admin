        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center lg:my-4 my-2 space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                    <svg aria-hidden="true" class="w-6 h-6 text-slate-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                    <a href="/transaksi_keluar/create" class="ml-1 text-sm font-medium text-slate-700 hover:text-red-700 md:ml-2">{{ $subtitle }}</a>
                    </div>
                </li>
            </ol>
        </nav>
                        ...
                        <div class="w-full">
                            <div class='grid grid-cols-12 gap-1'>
                                ...
                                <div class='lg:col-span-6 col-span-12 mb-3'>
                                    ...
                                    <input type='text' name='kode_transaksi' id='kode_transaksi' value="{{ $kode_transaksi }}" class="lg:w-[300px] w-full p-1 rounded-md border @error('kode_transaksi') border-red-400 @enderror focus:border-red-400 focus:ring-red-400">
                            ...
                            <div class='grid grid-cols-12 gap-1'>
                                ...
                                <div class="lg:col-span-6 col-span-12 mb-3">
                                    ...
                                    <select name='kode_pembelian' id='kode_pembelian' {{ old('check') ? 'disabled' : '' }} class="lg:w-[300px] w-full p-1 rounded-md border @error('kode_pembelian') border-red-400 @enderror focus:border-red-400 focus:ring-red-400">
                            ...
                            <div class="flex mb-3">
                                <input type="checkbox" name="check" id="check" {{ (old('check')) ? 'checked' : '' }} class="rounded border border-slate-400 text-red-700 focus:ring-red-700">
                            ...
                            <div class='grid grid-cols-12 gap-1'>
                                ...
                                <div class='lg:col-span-6 col-span-12 mb-3'>
                                    ...
                                    <input type='text' name='pembayaran_lain' id='pembayaran_lain' value="{{ old('pembayaran_lain') }}" {{ old('check') ? ' ' : 'disabled' }} class="lg:w-[300px] w-full bg-slate-200 p-1 rounded-md border @error('pembayaran_lain') border-red-400 @enderror focus:border-red-400 focus:ring-red-400">
                            ...
                            <div class="grid grid-cols-12 gap-1">
                                <div class="lg:col-span-6 col-span-12 mb-3 lg:flex">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type='number' name='nominal' id='nominal' value="{{ old('nominal') }}" class='nominal lg:w-[270px] w-full p-1 rounded-r-md rounded-y-md border @error('nominal') border-red-400 @enderror focus:border-red-400 focus:ring-red-400'>
                                    </div>
                                    @error('nominal')
                                    <div class="text-red-700 text-start">
                                        {{ $message }}
                            ...
                            <div class='grid grid-cols-12 gap-1'>
                                ...
                                <div class='lg:col-span-6 col-span-12 mb-3'>
                                    ...
                                    <input type='text' name='tujuan_transaksi' id='tujuan_transaksi' value="{{ old('tujuan_transaksi') }}" class="lg:w-[300px] w-full p-1 rounded-md border @error('tujuan_transaksi') border-red-400 @enderror focus:border-red-400 focus:ring-red-400">
                            ...
                            <div class="grid grid-cols-12 gap-1 mb-3">
                                ...
                                <div class="lg:col-span-6 col-span-12 lg:flex">
                                    ...
                                    <textarea name="keterangan" id="keterangan" cols="30" rows="3" class="block lg:w-[300px] w-full p-1 rounded-md border focus:border-red-400 focus:ring-red-400"></textarea>
                                    @error('keterangan')
                                    <div class="text-red-700 text-start">
                                        {{ $message }}
                                    </div>
