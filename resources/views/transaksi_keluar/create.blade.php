                            ...
                            <div class='flex'>
                                ...
                                <div class='flex mb-3'>
                                    ...
                                    <div>
                                        ...
                                        @endphp
                                        <input type='text' name='kode_transaksi' id='kode_transaksi' value="{{ $transaksi->isEmpty() ? 'TK-1' : 'TK-'.$id[1] + 1 }}" class="w-[300px] p-1 rounded-md border @error('kode_transaksi') border-red-400 @enderror focus:border-red-400 focus:ring-red-400">
