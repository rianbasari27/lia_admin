...
<nav role="navigation"
  ...
  class="flex items-center justify-between py-4 border-t select-none border-secondary-200 dark:border-secondary-600">
  <div class="flex justify-between flex-1 sm:hidden">
    ...
    <a href="{{ $paginator->previousPageUrl() }}"
      class="relative inline-flex items-center px-4 py-2 text-sm font-medium leading-5 transition bg-white border border-gray-300 rounded dark:text-gray-200 dark:border-secondary-600 hover:text-gray-400 dark:hover:text-gray-300 focus:outline-none focus:border-slate-300 focus:ring focus:ring-slate-300 focus:ring-opacity-30 dark:bg-secondary-700 dark:focus:ring-slate-500 dark:focus:ring-opacity-30">
      {!! __('pagination.previous') !!}
    </a>
    @endif
    {{-- next enable --}}
  ...
  <div class="flex-col hidden lg:flex-row sm:flex-1 sm:flex sm:items-center sm:justify-between">
    ...
    <div>
      <span class="relative z-0 inline-flex mt-2 shadow-sm lg:mt-0">
        ...
        <a href="{{ $paginator->previousPageUrl() }}"
          rel="prev"
          class="relative inline-flex items-center px-2 py-2 text-sm font-medium leading-5 transition bg-white text-slate-700 border border-gray-300 rounded-l hover:text-white hover:bg-red-600 focus:z-10 focus:outline-none focus:border-slate-300 focus:ring focus:ring-slate-300 focus:ring-opacity-30 dark:focus:ring-slate-500 dark:focus:ring-opacity-30 dark:text-gray-300 dark:border-secondary-600 dark:bg-secondary-700"
          aria-label="{{ __('pagination.previous') }}">
          <svg class="w-5 h-5"
            fill="currentColor"
            viewBox="0 0 20 20">
        ...
        <span aria-current="page">
          <span
            class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-white bg-red-700 border border-gray-300 dark:text-gray-400 dark:border-secondary-600 dark:bg-secondary-700">{{ $page }}</span>
        </span>
        @else
        {{-- Array Of Links Enable --}}
        <a href="{{ $url }}"
          class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium leading-5 transition bg-white border border-gray-300 hover:text-gray-400 dark:hover:text-gray-300 focus:z-10 focus:outline-none focus:border-slate-300 focus:ring focus:ring-slate-300 focus:ring-opacity-30 dark:focus:ring-slate-500 dark:focus:ring-opacity-30 dark:text-gray-200 dark:border-secondary-600 dark:bg-secondary-700"
        ...
        <a href="{{ $paginator->nextPageUrl() }}"
          rel="next"
          class="relative inline-flex items-center px-2 py-2 -ml-px text-sm font-medium leading-5 transition bg-white border border-gray-300 rounded-r hover:text-gray-400 focus:z-10 focus:outline-none focus:border-slate-300 focus:ring focus:ring-slate-300 focus:ring-opacity-30 dark:focus:ring-slate-500 dark:focus:ring-opacity-30 dark:text-gray-200 dark:border-secondary-600 dark:bg-secondary-700"
