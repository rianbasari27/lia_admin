    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center my-4 space-x-1 md:space-x-3">
            ...
            <li>
                ...
                <a href="/laporan_kas_keluar" class="ml-1 text-sm font-medium text-slate-700 hover:text-red-700 md:ml-2">{{ $title }}</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                <svg aria-hidden="true" class="w-6 h-6 text-slate-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                <a href="/laporan_kas_keluar" class="ml-1 text-sm font-medium text-slate-700 hover:text-red-700 md:ml-2">{{ $subtitle }}</a>
                </div>
            </li>
        </ol>
    </nav>
            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    @if ($data->count())
                        ...
                        @endforeach
                        <tr>
                            <td class="border border-slate-300 p-2 text-end font-bold" colspan="5">Total Pengeluaran</td>
                            <td class="border border-slate-300 p-2 text-end font-bold">Rp {{ number_format($total->total, 0, ',', '.') }}</td>
                        </tr>
                    @else 
